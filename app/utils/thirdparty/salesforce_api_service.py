...
class SalesforceApiService:
    ...
    def get_salesforce_users(self):
        ...
        """
        try:
            query = "SELECT Id, Name, LinkedIn_Profile__c, PersonEmail, Summary_of_Candidate__c, OwnerId, Gong__Gong_Count__c, Current_OTE__c, Consulting_Status__c, Status__c, IsDeleted FROM Account WHERE RecordType.Name = 'Candidate- Person Accounts'"
